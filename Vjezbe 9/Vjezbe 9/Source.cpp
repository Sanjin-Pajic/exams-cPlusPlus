...
public:
    ...
    Greska(const Greska& obj) : exception(obj) {
        _linija = obj.Linija;
        _funkcija = Alokator(obj.Funkcija);
    }
    //Z0.6
...
public:
    ...
    //Z1.3
    Vektor(Vektor<T>&& obj) noexcept {
        _trenutno = obj._trenutno;
        _maxElemenata = obj._maxElemenata;
        _elementi = obj._elementi;
        obj._trenutno = 0, obj._elementi = nullptr;
    }
...
public:
    ...
    Spol GetSpol() const { 
        if (_spol == nullptr) throw Greska("SPOL JE NULLPTR!", __LINE__, __FUNCTION__);
        return *_spol; 
    }
    float GetVisina() const {
        if (_visina == nullptr) throw Greska("Visina je nullptr", __LINE__, __FUNCTION__);
        return *_visina;
    }
    Boja GetBojaOciju() const {
        if (_bojaOciju == nullptr) throw Greska("BojaOciju je nullptr", __LINE__, __FUNCTION__);
        return *_bojaOciju;
    }
    Boja GetBojaKose() const {
        if (_bojaKose == nullptr) throw Greska("BojaKose je nullptr", __LINE__, __FUNCTION__);
        return *_bojaKose;
    }
    //Z3.6
    ...
    ~Osoba() {
        ...
        _jmbg = nullptr, _bojaOciju = _bojaKose = nullptr, _visina = nullptr;
    }
};
//Z3.9
...
public:
    ...
    //Z4.4
    Teniser(Teniser&& obj) noexcept: Osoba(move(obj)), _osvojeniNaslovi(move(obj._osvojeniNaslovi)) {
        _ranking = move(obj._ranking);
    }
    //Z4.5
    Vektor<const char*> GetOsvojeniNaslovi() const { return _osvojeniNaslovi; }
    int GetRanking() const { 
        if (_ranking == nullptr) throw Greska("Ranking je nullptr", __LINE__, __FUNCTION__);
        return *_ranking; 
    }
    //Z4.6
    ...
    Teniser& operator = (const Teniser& obj) {
        if (this == &obj)
            return *this;
        (Osoba&)* this = obj;
        OsvojeniNaslovi = obj.OsvojeniNaslovi;
        Ranking = obj.Ranking;
        return *this;
    }
    //Z4.8
...
public:
    ...
    Teniser GetPrvi() const { 
        if (_prvi == nullptr) throw Greska("Prvi teniser je nullptr", __LINE__, __FUNCTION__);
        return *_prvi; 
    }
    Teniser GetDrugi() const {
        if (_drugi == nullptr) throw Greska("Drugi teniser je nullptr", __LINE__, __FUNCTION__);
        return *_drugi;  
    }
