...
public:
    ...
    Kolekcija operator[] (T1 vrijednost) {
    ...
    koji kao vrijednost T1 imaju proslijedjenu vrijednost*/
        ...
        for (int i = 0; i < *_trenutno; i++)
        {
            if (_elementi1[i] == vrijednost) nova.AddElement(_elementi1[i], _elementi2[i]);
        }
        return nova;
    }
...
public:
    ...
    Ispit(const Ispit& obj): _pitanjaOdgovori(obj._pitanjaOdgovori), _predmet(obj._predmet) {
