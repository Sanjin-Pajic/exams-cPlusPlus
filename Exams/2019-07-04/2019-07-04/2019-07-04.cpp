...
public:
	Nastavnik(string imePrezime, Kolekcija<string, ZavrsniRad>teme) : Osoba(imePrezime), _teme(teme) {
	}
...
int main() {
	Kolekcija<string, ZavrsniRad> teme;
	Nastavnik denis("Denis Music", teme);
